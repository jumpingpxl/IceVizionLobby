...
public class ItemUtil {
    ...
    private HashMap<Integer, ItemStack> loadLayout() {
        ...
        layout.put(1, PANE);
        layout.put(6, new ItemBuilder(Material.GRAY_DYE).setDisplayName("Jeder").build());
        layout.put(7, new ItemBuilder(Material.GRAY_DYE).setDisplayName("Freunde").build());
        layout.put(8, new ItemBuilder(Material.GRAY_DYE).setDisplayName("Keiner").build());
        layout.put(9, new ItemBuilder(Material.FIREWORK_ROCKET).setDisplayName("§dParty").build());
        layout.put(10, PANE);
        layout.put(15, new ItemBuilder(Material.GRAY_DYE).setDisplayName("Jeder").build());
        layout.put(16, new ItemBuilder(Material.GRAY_DYE).setDisplayName("Freunde").build());
        layout.put(17, new ItemBuilder(Material.GRAY_DYE).setDisplayName("Keiner").build());
        ...
        layout.put(19, PANE);
        layout.put(24, new ItemBuilder(Material.GRAY_DYE).setDisplayName("Jeder").build());
        layout.put(25, new ItemBuilder(Material.GRAY_DYE).setDisplayName("Freunde").build());
        layout.put(26, new ItemBuilder(Material.GRAY_DYE).setDisplayName("Keiner").build());
        layout.put(27, new ItemBuilder(Material.ENDER_EYE).setDisplayName("§aNachspringen").build());
        layout.put(28, PANE);
        layout.put(34, new ItemBuilder(Material.GRAY_DYE).setDisplayName("Freunde").build());
        layout.put(35, new ItemBuilder(Material.GRAY_DYE).setDisplayName("Keiner").build());
